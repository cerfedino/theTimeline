...
\section{The project}
    ...
    \subsection{Example page}
        ...
        .2 html \ldots{..}\ldots{}\ldots{}\ldots{}\ldots{}\ldots{}\ldots{}\ldots{} \begin{minipage}[t]{0.8\linewidth}
                            Every page has a folder inside this directory{.}
                            \end{minipage}. 
        .3 \colorbox{yellow!30}{gen\#\underline{ }example\underline{ }page} \ldots{.}\ldots{}\ldots{} \begin{minipage}[t]{0.8\linewidth}
                            The directory of the page 'example\underline{ }page'{.}
                            \end{minipage}. 
        .4 \colorbox{yellow!30}{media} \ldots{..}\ldots{}\ldots{}\ldots{}\ldots{}\ldots{} \begin{minipage}[t]{0.8\linewidth}
                            Here goes all the media used by 'example\underline{ }page{.}html' {.}
                            \end{minipage}. 
        .4 \colorbox{yellow!30}{example\underline{ }page{.}html} \ldots{}\ldots{}\ldots{} \begin{minipage}[t]{0.8\linewidth}
                            The {.}html page{.}
                            \end{minipage}. 
        .3 {...} .
        }
        ...
        \subsubsection{Remarks}
            \begin{itemize}
            \item Every page folder has the prefix \textit{gen\#\underline{ }} indicating the generation (e.g \textit{gen1\underline{ }example\underline{ }page})
