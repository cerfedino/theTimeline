...
\section{The project}
    ...
    \subsection{Example page}
        ...
        .2 html \ldots{..}\ldots{}\ldots{}\ldots{}\ldots{}\ldots{}\ldots{}\ldots{} \begin{minipage}[t]{0.8\linewidth}
                            Every page has a folder inside this directory{.}
                            \end{minipage}. 
        .3 \colorbox{yellow!30}{gen\#\underline{ }examplepage} \ldots{.}\ldots{}\ldots{} \begin{minipage}[t]{0.8\linewidth}
        ...
        \subsubsection{Remarks}
            \begin{itemize}
            \item Every page folder has the prefix \textit{gen\#\underline{ }} indicating the generation (e.g \textit{gen1\underline{ }examplepage})
